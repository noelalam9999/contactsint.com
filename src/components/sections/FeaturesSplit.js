          ...
          <div className={splitClasses}>
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-left" data-reveal-container=".split-item">
                ...
                We bring top Universities to you
                </h1>
                <p className="m-0">
                Contacts International presents informative and engaging webinars to ensure that no matter the circumstances, prospective students get the opportunity to speak directly with universities and receive the best information on offer.
                  </p>
              </div>
             <div className={
                classNames(
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-right" data-reveal-container=".split-item">
                ...
                <p className="m-0">
                Make sure to register for our Webinars to meet directly with top International Universities from the comfort of your own home. Get the opportunity to speak directly with university representatives and receive first-hand information directly from the University. 
                  </p>
              </div>
              <div className={
                classNames(
